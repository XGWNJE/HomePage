...
<p align="center">
  <img src="./assets/readme/home-desktop.webp" alt="XGWNJE 当前生产主页的桌面端界面" width="100%" />
</p>
...
文章页会根据内容长度与标题结构自动选择目录或居中阅读布局，短文不会为了填满导航而被迫增加章节。

<p align="center">
  <img src="./assets/readme/article-mobile.webp" alt="XGWNJE 当前生产文章页的移动端阅读布局" width="360" />
</p>
