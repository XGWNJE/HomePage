...
- `curl -I https://xgwnje.cn/sitemap-index.xml`
- `curl -I https://xgwnje.cn/sitemap-0.xml`
- `curl -I https://xgwnje.cn/sitemap.xml`
...
1. Open any production page on `https://xgwnje.cn/`.
